import { StyleSheet, Text, View , Dimensions  , ScrollView , ActivityIndicator, FlatList} from 'react-native'
...
return (
    <ScrollView style={styles.container} bounces={false}>
      ...
      <FlatList
        ...
        bounces={false}
        decelerationRate={0}
        snapToInterval={(width - (width * 0.8 + SPACING.space_36 * 2)) / 2} //your element width
